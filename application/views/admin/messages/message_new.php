...
<div class="row">
	<div class="col-md-6">
		...
		<input name="receiver_id" id="receiver_id" value="<?php echo $receiver->id; ?>" type="hidden">
		<input name="receivername" id="receivername" value="<?php echo $receiver->username; ?>" type="hidden">
...
var sendChat = function (message, callback) {
	$.getJSON('<?php echo base_url(); ?>admin/send_message?message=' + message + '&sender_id=' + sender_id + '&groupp=' + group + '&sendername=' + sendername + '&receiver_id=' + receiver_id + '&receivername=' + receivername , function (data){
		//callback();
	});
}
...
var update_chats = function () {
	...
	$.getJSON('<?php echo base_url(); ?>admin/get_messages?sender_id=' + sender_id + '&receiver_id=' + receiver_id, function (data){
