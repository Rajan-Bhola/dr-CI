...
<h3 class="page-header">
	Messages	<a href="<?php echo base_url(); ?>admin/addnewmessage" class="btn btn-default btn-sm">New Message</a>
</h3>
		...
		<?php foreach ($users as $user)
{
	...
	?>
		...
		<td><a href="<?php echo base_url()."admin/view_message?sender_id=$user->receiver_id&message_id=$user->id";?>" title="Reply"><?php echo $user->message; ?></a></td>
		<td><a href="<?php echo base_url().'users/index/'.$user->sender_id; ?>" target="_blank"><?php echo $user->sendername; ?></a>/<a href="<?php echo base_url().'users/index/'.$user->receiver_id; ?>" target="_blank"><?php echo $user->receivername; ?></a></td>
		<td><span title="2017-06-29 04:56:39"><?php echo $user->timestamp; ?></span></td>
		<td><a href="<?php echo base_url()."admin/view_message?sender_id=$user->receiver_id&message_id=$user->id";?>" title="Reply"><span class="glyphicon glyphicon-share-alt"></span></a> <a href="<?php echo base_url().'admin/message_delete/'.$user->id; ?>" title="Delete this conversation"><span class="glyphicon glyphicon-trash"></span></a></td>
		</tr>
<?php } ?>
...
{ ?>
	<tr role="row" class="<?php if($n->status == 0) { echo 'info'; } ?> odd">
		<td><input name="messages[]" value="2" class="chb-select" type="checkbox"></td>
		<td><a href="<?php echo base_url()."admin/view_message?sender_id=$n->sender_id&message_id=$n->id";?>" title="Reply"><?php echo $n->message; ?></a></td>
		<td><a href="<?php echo base_url().'users/index/'.$n->sender_id; ?>" target="_blank"><?php echo $n->sendername; ?></a>/<a href="<?php echo base_url().'users/index/'.$n->receiver_id; ?>" target="_blank"><?php echo $n->receivername; ?></a></td>
		<td><span title="2017-06-29 04:56:39"><?php echo $n->timestamp; ?></span></td>
		<td><a href="<?php echo base_url()."admin/view_message?sender_id=$n->sender_id&message_id=$n->id";?>" title="Reply"><span class="glyphicon glyphicon-share-alt"></span></a> <a href="<?php echo base_url().'admin/message_delete/'.$n->id; ?>" title="Delete this conversation"><span class="glyphicon glyphicon-trash"></span></a></td>
		</tr>
<?php } ?>
